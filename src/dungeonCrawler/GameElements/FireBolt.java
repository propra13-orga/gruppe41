...
public class FireBolt extends GameElement {
	...
	public static FireBolt createElement(String[] param) {
		...
		try {
			...
			System.out.println("Kann FIREBOLT-Parameter nicht interpretieren.");
		}
		return (new FireBolt(position, size));
	}
